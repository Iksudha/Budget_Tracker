...
class TransactionAdapter (private val transactionList: ArrayList<TransactionModel>) : RecyclerView.Adapter<TransactionAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (currentTransaction.type == 1){
            ...
            holder.tvTransactionAmount.setTextColor(Color.parseColor("#76ba1b"))
        }
        ...
        if (currentTransaction.type == 1){
            holder.typeIcon.setImageResource(R.drawable.ic_down)
        }else{
            holder.typeIcon.setImageResource(R.drawable.ic_up) //ic_moneyin_svgrepo_com
        }
    }
